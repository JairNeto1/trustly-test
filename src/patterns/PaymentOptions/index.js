  ...
  return (
    <Form>
      ...
      <section onClick={getPaymentMethod} >
        <input type="radio" name="payment-method" id="online-banking" value="online-banking" defaultChecked />
      ...
      <section onClick={getPaymentMethod} >
        <input type="radio" name="payment-method" id="card-payment" value="card-payment" />
